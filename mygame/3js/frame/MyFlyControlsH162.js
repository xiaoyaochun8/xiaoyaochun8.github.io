	...
	constructor( object, domElement ) {
		...
		this.keydown = function ( event ) {
			...
			switch ( event.code ) {
				...
				case 'KeyA': this.moveState.left = 1; this.moveState.yawLeft = 1; break;
				case 'KeyD': this.moveState.right = 1; this.moveState.yawRight = 1; break;
		...
		this.keyup = function ( event ) {
			...
			switch ( event.code ) {
				...
				case 'KeyA': this.moveState.left = 0; this.moveState.yawLeft = 0; break;
				case 'KeyD': this.moveState.right = 0; this.moveState.yawRight = 0; break;
